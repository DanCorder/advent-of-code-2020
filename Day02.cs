namespace advent_of_code_2020
{
    ...
    public class Day02
    {
        private const string ProblemInput = @"1-8 n: dpwpmhknmnlglhjtrbpx
...
6-7 q: qqqqvqhq";
        ...
        public static int SolveProblem1()
        {
            ...
            var parsed = ProblemInput
                .SplitToLines()
                .Select(l => {
                    var m = regex.Match(l);
                    return new Tuple<int, int, char, string>(
            ...
            var filtered = parsed
                .Where(r => 
                {
                    var count = r.Item4.Count(c => c == r.Item3);
                    return count >= r.Item1 && count <= r.Item2;
                })
                .ToList();
        ...
        public static int SolveProblem2()
        {
            ...
            var filtered = parsed
                .Where(r =>
                {
                    var c1 = r.Item4[r.Item1 - 1];
                    var c2 = r.Item4[r.Item2 - 1];
                    return (c1 == r.Item3 && c2 != r.Item3) || (c1 != r.Item3 && c2 == r.Item3);
                })
                .ToList();
